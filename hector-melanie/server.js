...
app.get('/articles', (request, response) => {
  client.query(`SELECT * FROM articles INNER JOIN authors ON authors.author_id=article.author_id`)
    .then(result => {
...
app.post('/articles', (request, response) => {
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT INTO articles(author_id, title, author, "authorUrl", category, "publishedOn", body)`,
      [
        author_id,
        request.body.title,
        request.body.author,
